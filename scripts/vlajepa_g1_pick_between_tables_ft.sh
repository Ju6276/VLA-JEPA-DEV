#!/bin/bash
# G1 pick-between-tables fine-tuning with V-JEPA 2.1 ViT-L/384 (weights under VJEPA21/).
...
echo "Config: scripts/config/vlajepa_g1_pick_between_tables_ft.yaml (V-JEPA 2.1, 384px)"
echo "Encoder: VJEPA21/vjepa2_1_vitl_dist_vitG_384.pt"
echo "Output: checkpoints/g1_pick_between_tables_vjepa21_ft"
